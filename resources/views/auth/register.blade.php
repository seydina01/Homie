        ...
        <form method="POST" action="{{ route('register') }}" class="text-start">
            ...
            <div class="grid grid-cols-1">
                <div class="mb-4">
                    ...
                    <input type="text" id="firstName" name="firstName" placeholder="Prenom" class="mt-3 w-full border-gray-200 rounded-lg focus:ring-0" required autofocus  style="border: 1px solid #ced4da; transition: border-color 0.2s ease-in-out;"onfocus="this.style.borderColor='#16a14a';this.style.outline='none'"onblur="this.style.borderColor='#ced4da';" >
