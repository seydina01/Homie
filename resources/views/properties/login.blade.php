...
@section('content')
<!--login-->
<div class=" mt-40 max-w-[400px] w-full m-auto p-6 bg-white shadow-md rounded-lg text-gray-700">
        ...
        <div class="grid grid-cols-1">
            <div class="grid grid-cols-1">
                ...
                <div class="text-center">
                    ...
                    <a href="#" class="text-gray-900 hover:text-slate-600">Créer un compte</a>
                </div>
            </div>
